...
/*function drawOutBoxPlot(infosys,tcs,wipro,ibm,acc){
    var trace1 = {
        y: infosys,
        type: 'box',
        name: 'INFOSYS'
...
$( document ).ready(function(){
    ...
    var infosys, tcs, wipro,ibm,acc, remaining = 5;
    ...
    d3.csv("data/wage_infosys.csv", function(error, data) {
        ...
        if (!--remaining) drawOutBoxPlot(infosys, tcs, wipro,ibm,acc);
...
function drawSoftBoxPlot(msft,google,amazon,oracle,apple){
...
$( document ).ready(function(){
    ...
    var msft, google, amazon, oracle, apple, remaining = 5;
    
    d3.csv("data/wage_msft_2016.csv", function(error, data) {
        msft = $.map(data, function(value, index) {
            return value.Wage;
        });
        if (!--remaining) drawSoftBoxPlot(msft,google,amazon,oracle,apple);
    });
...
function drawBoxPlot(infosys,tcs,wipro,ibm,acc,msft,google,amazon,oracle,apple){
    var trace1 = {
        y: infosys,
        type: 'box',
        name: 'INFOSYS',
...
function drawBoxPlots(){
    ...
    d3.csv("data/wage_infosys.csv", function(error, data) {
        ...
        if (!--remaining) drawBoxPlot(infosys,tcs,wipro,ibm,acc,msft,google,amazon,oracle,apple);
